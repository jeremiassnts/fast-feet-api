...
describe('Edit recipient', () => {
    beforeEach(() => {
        ...
        sut = new EditRecipientUseCase(inMemoryUsersRepository, inMemoryRecipientsRepository)
    })
    ...
    it('should be able to edit an recipient', async () => {
        ...
        const updatedRecipient = inMemoryRecipientsRepository.items.find(o => o.id === recipient.id)
